...
/**
 * TODO describe file courseslider
 *
...
$url = new moodle_url('/local/ourteacher/courseslider.php', []);
$PAGE->set_url($url);
...
echo $OUTPUT->render_from_template('local_ourteacher/courseslider', ['courses' => array_values($data)]);
echo $OUTPUT->footer();
