...
class edit_data extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventeditdata', 'externship');
    }
    
    public function get_description() {
        return "The user with id '{$this->userid}' updated the externship data with id '{$this->objectid}' in the course with id '{$this->courseid}'.";
    }
