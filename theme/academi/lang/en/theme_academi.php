...
// General.
$string['home'] = "Home";
$string['homevideo'] = "Home video";
$string['headerheading'] = 'General';
$string['homevideoheading'] = 'Home video';
$string['homevideostatus'] = 'Status';
$string['logo'] = 'Logo';
...
$string['mbadescription'] = "The Master of Business Administration (MBA) is a prestigious postgraduate degree designed to develop advanced business and management skills.";
$string['onlineclass'] = "Online classes are a flexible and convenient way of learning through digital platforms. They allow students to access educational content, interact with instructors, and complete assignments remotely. ";
$string['realmeeting'] = "A real meeting involves face-to-face interaction between individuals in a physical location. It facilitates direct communication, fostering stronger connections, collaboration, and immediate feedback ";
